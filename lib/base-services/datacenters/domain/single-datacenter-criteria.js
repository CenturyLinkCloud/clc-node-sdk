 ...
 * @type {object}
 *
 * @property {string} id - a ID of target data center
 * @property {string} name - a name of target data center
 * @property {string} nameContains - search data centers which name contains specified keyword

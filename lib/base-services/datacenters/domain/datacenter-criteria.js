...
function DataCenterCriteria (criteria) {
    ...
    self.extractPredicateFromCriteria = function () {
        ...
        return self.extractPredicateFromFilterCriteria();
    };
    ...
    self.resolveConditionalCriteria = function () {
        ...
        _.each(expressions, function(expression) {
            ...
            if (subCriteria.isConditionalCriteria()) {
                ...
                predicate = predicate[condition](subCriteria.extractPredicateFromFilterCriteria());
            }
        });
    ...
    self.extractPredicateFromFilterCriteria = function (path) {

...
var PolicyCriteria = require("./domain/anti-affinity/policy-criteria.js");
...
function AntiAffinity(dataCenterService, policyClient, queueClient) {
    ...
    self.create = function (command) {
        ...
        return new NoWaitOperationPromise(queueClient, processPolicyRefs, "Create Policy").from(result);
    };
    ...
    self.delete = function () {
        ...
        return new NoWaitOperationPromise(queueClient, "Delete Policy").from(result);
    };

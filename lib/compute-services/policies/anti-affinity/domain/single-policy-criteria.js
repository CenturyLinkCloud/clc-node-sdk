...
function SinglePolicyCriteria(criteria) {
    ...
    function getDataCenterPredicate() {
        if (criteria.dataCenter) {
            return new DataCenterCriteria(criteria.dataCenter).predicate("dataCenter");
        }
            return Predicate.alwaysTrue();
    }
    ...
    self.parseDataCenterCriteria = function () {
        ...
        var arrayCriteria = parsedCriteria.dataCenter ? _.asArray(parsedCriteria.dataCenter, dataCenterCriteria)

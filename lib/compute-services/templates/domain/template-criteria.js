...
var SingleDataCenterCriteria = require('./../../../base-services/datacenters/domain/single-datacenter-criteria.js');
...
function TemplateCriteria (nakedCriteria) {
    ...
    function resolveFilterCriteria(criteria, condition) {
        var dataCenterPredicate = new SingleDataCenterCriteria(TemplateCriteria.extractDataCenterCriteria(criteria))
